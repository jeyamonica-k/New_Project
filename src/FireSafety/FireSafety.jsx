...
import one from "../images/fire and safety CD.png"
  ...
  return (
    <div className="flex flex-col relative shadow-xl m-4 ">
      ...
      <div className={`absolute left-0 bottom-[5%] flex flex-col p-2 m-3 gap-2 bg-black/50 md:w-[70%] transition-all duration-1000 ${animate?"translate-y-full opacity-0":"translate-y-0 opacity-100"}`}>
        <h3 className='text-white md:text-2xl lg:text-3xl font-bold'>Fire & Safety</h3>
        <p className='text-gray-300 md:text-xl lg:text-2xl font-medium'>Fire & Safety education involves fire prevention, emergency response, safety protocols, risk management and hazard assessment.</p>
      </div>
      </div>
    </div>
  )
